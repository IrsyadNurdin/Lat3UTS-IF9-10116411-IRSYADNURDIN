...
import com.example.Lat3UTS_IF9_10116411_IRSYADNURDIN.Gallery.GalleryData;
import com.example.Lat3UTS_IF9_10116411_IRSYADNURDIN.Gallery.GridGalleryAdapter;
...
//        return inflater.inflate(R.layout.fragment_gallery, container, false);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        list.addAll(GalleryData.getListData());
//        showRecyclerList();
        showRecyclerGrid();
    }
    ...
    private void showRecyclerGrid(){
        ...
        GridGalleryAdapter gridGalleryAdapter = new GridGalleryAdapter(context);
        gridGalleryAdapter.setListGetterSetter(list);
